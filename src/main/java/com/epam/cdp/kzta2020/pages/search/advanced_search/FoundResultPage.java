...
public class FoundResultPage extends AbstractPage {
    ...
    private static final By BODY_TYPE_PARAMETER_LOCATOR = By.cssSelector("dl:nth-child(3) > dd.value");
    private static final By ENGINE_VOLUME_PARAMETER_LOCATOR = By.cssSelector("dl:nth-child(4) > dd.value");
    private static final By LOCATION_OF_WHEEL_PARAMETER_LOCATOR = By.cssSelector("dl:nth-child(7) > dd.value");
    private static final By DRIVE_UNIT_PARAMETER_LOCATOR = By.cssSelector("dl:nth-child(8) > dd.value");
    ...
    public boolean isImageDisplayed() {
        waitForElementVisibility(IMAGE_LOCATOR);
    ...
    public boolean isModelCorrect(Car car) {
        return Optional.of(getText(MODEL_LOCATOR, driver).toLowerCase().replace(" ","-")).equals(car.getModel());
    }
}
