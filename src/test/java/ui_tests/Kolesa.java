...
public class Kolesa extends WebDriverInitializer {

    @Test(groups = {"UiTest"})
    public void publishAdvertTest() {
        SoftAssert softAssert = new SoftAssert();
        new HomePage(driver).openLogInPage().signIn(UserCreator.getUser());
    ...
    public void searchWithPhoto() {
        ...
        com.epam.cdp.kzta2020.pages.search.search_with_photo.HomePage homePage = new com.epam.cdp.kzta2020.pages.search.search_with_photo.HomePage(driver);
        homePage.openAutoSection();
