...
public class CustomizationAdvertPage extends AbstractPage {
    ...
    public CustomizationAdvertPage configureCategory1(String category1) {
        ...
        getDriver().findElement(By.xpath(String.format(CATEGORY_LOCATOR, category1))).click();
        return this;
    }
    ...
    public CustomizationAdvertPage configureCategory2(String category2) {
        ...
        getDriver().findElement(By.xpath(String.format(CATEGORY_LOCATOR, category2))).click();
        return this;
    }

    public CustomizationAdvertPage configureMark(String mark) {
        waitForElementEnabled(By.xpath(String.format(MARK_LOCATOR, mark)));
        getDriver().findElement(By.xpath(String.format(MARK_LOCATOR, mark))).click();
        return this;
    }
    ...
    public CustomizationAdvertPage configureModel(String model) {
        ...
        getDriver().findElement(By.xpath(String.format(MODEL_LOCATOR, model))).click();
        return this;
    }
    ...
    public CustomizationAdvertPage configureModelYear(String year) {
        ...
        getDriver().findElement(By.xpath(String.format(MODEL_YEAR_LOCATOR, year))).click();
        return this;
    }
    ...
    public CustomizationAdvertPage configureEngineType(String type) {
        ...
        getDriver().findElement(By.xpath(String.format(ENGINE_TYPE_LOCATOR, type))).click();
        return this;
    }

    public CustomizationAdvertPage configureModification(String modification) {
//        ((JavascriptExecutor) driver).executeScript("scroll(0,900)");
        waitForElementVisibility(By.xpath(String.format(MODIFICATION_LOCATOR, modification)));
        getDriver().findElement(By.xpath(String.format(MODIFICATION_LOCATOR, modification))).click();
        return this;
    }
    ...
    public CustomizationAdvertPage configureCity(String city) {
        ...
        WebElement item = getDriver().findElement(new ByChained(ADVERT_OPTION_CHOOSE_CITY_LOCATOR, By.xpath(String.format("//ul/li[contains(.,'%s')]", city))));
